...
//         <p className='text-xl font-extrabold mb-4'>Nidhi Saxena – Filmmaker, Writer, and Visual Storyteller</p>
...
//       <div className='flex flex-col md:flex-row gap-6 py-6 px-4 lg:px-[20vw] md:px-[10vw]'>
//         {/* Ajender Card */}
//         <div className='w-full md:w-1/2 p-4 '>
//           <img src={ajendra} className='rounded-sm mb-4 w-full h-auto' />
//           <p className='text-lg font-bold mb-1'>Ajender Singh</p>
//           <p className='text-sm font-semibold mb-3'>Co-founder & Producer</p>
...
//           <p className='text-lg font-bold mb-1'>Rahul Saxena</p>
//           <p className='text-sm font-semibold mb-3'>Producer</p>
//           <p className='leading-6'>
